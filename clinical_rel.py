...
def main():
    ...
    parser.add_argument("--data_type",
                        default="ipf",
                        type=str,
                        help="file type, multihead conll format.")
    ...
    parser.add_argument("--pretrained_model",
                        default="../pretrained_model/NICT_BERT-base_JapaneseWikipedia_32K_BPE",
                        type=str,
    ...
    parser.add_argument("--saved_model", default='../result/tmp', type=str,
            ...
            for epoch in range(1, args.num_epoch + 1):
                ...
                for step, batch in enumerate(epoch_iterator):
                    ...
                    if args.do_distill:
                        ...
                        rel_loss = args.alpha * rel_loss + (1 - args.alpha) * rel_loss_distill
                    ...
                    if epoch > 5:
                        if ((step + 1) % save_step_interval == 0) or (step == num_epoch_steps - 1):
                            eval_joint(model, dev_dataloader, dev_comment, dev_tok, dev_ner, dev_mod, dev_rel, dev_spo,
                                    ...
                                    print_levels=(0, 0, 0), out_file=dev_output, verbose=0)
                            dev_evaluator = MhsEvaluator(dev_file, dev_output)
                ...
                eval_joint(model, dev_dataloader, dev_comment, dev_tok, dev_ner, dev_mod, dev_rel, dev_spo, bio2ix,
                        ...
                        print_levels=(1, 1, 1), out_file=dev_output, verbose=0)
                dev_evaluator = MhsEvaluator(dev_file, dev_output)
