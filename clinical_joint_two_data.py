...
def main():
    ...
    parser.add_argument("--train_file2",
                        default="data/2021Q1/mr150/doc_conll/cv0_train.conll",
                        type=str,
                        help="train file, multihead conll format.")
    ...
    if args.do_train:
        ...
        train_comments2, train_toks2, train_ners2, train_mods2, train_rels2, bio2ix2, ne2ix2, mod2ix2, rel2ix2 = utils.extract_rel_data_from_mh_conll_v2(
            args.train_file2,
            down_neg=0.0
        )

        train_comments.extend(train_comments2)
        train_toks.extend(train_toks2)
        train_ners.extend(train_ners2)
        train_mods.extend(train_mods2)
        train_rels.extend(train_rels2)
        bio2ix.update(bio2ix2)
        ne2ix.update(ne2ix2)
        mod2ix.update(mod2ix2)
        rel2ix.update(rel2ix2)
