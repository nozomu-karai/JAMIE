...
def main():
    ...
    if args.do_train:
        ...
        with open(os.path.join(args.pretrained_model, 'ner2ix.json')) as json_fi:
            bio2ix = json.load(json_fi)
        with open(os.path.join(args.pretrained_model, 'mod2ix.json')) as json_fi:
            mod2ix = json.load(json_fi)
        with open(os.path.join(args.pretrained_model, 'rel2ix.json')) as json_fi:
